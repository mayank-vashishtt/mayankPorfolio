  ...
  return (
    <>
      ...
      <Container className="mt-20 mb-28">
        <div className="mt-5">
          <p className='text-zinc-600 dark:text-zinc-400 text-lg font-mono leading-7'>Throughout my journey in computer science, I have engaged in a variety of projects that have solidified my understanding and application of various technologies and concepts. My projects range from developing fundamental data structures and algorithms to building complex systems such as a multi-threaded file server, a basic operating system kernel, and web applications using modern frameworks.</p>
        </div>
        <div className='mt-16'>
